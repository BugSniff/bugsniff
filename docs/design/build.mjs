...
const PAGES = [
  ...
  },
  {
    ...
    boards: [
      ...
      ["ExameEscuro", A.Exame(true), 1440, 2160, "Exame · escuro"],
  ...
  },
  {
    ...
    boards: [
      ...
      ["FluxoFila", C.ExameNaFila, 1440, 700, "6 · Na fila"],
      [
        "FluxoLendo",
        A.ExameEsperando,
        1440,
      ...
      ["FluxoExame", A.Exame(), 1440, 2160, "8 · Exame pronto"],
